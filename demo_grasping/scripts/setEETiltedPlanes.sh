...
#set ee's on plane
rosservice call /yumi/hqp_vel_controller/set_tasks '{tasks: [ {t_type: 1, priority: 2, is_equality_task: true, task_frame: "world", ds: 0.0, di: 0.02, dynamics: {d_type: 1, d_data: [-1]}, t_links: [{link_frame: "world", geometries: [{g_type: 3, g_data: [0, -0.707, 0.707, -0.2]}]}, {link_frame: "gripper_l_base", geometries: [{g_type: 1, g_data: [0, 0, 0.15]}]}]}, {t_type: 1, priority: 2, is_equality_task: true, task_frame: "world", ds: 0.0, di: 0.02, dynamics: {d_type: 1, d_data: [-1]}, t_links: [{link_frame: "world", geometries: [{g_type: 3, g_data: [0, 0.707, 0.707, -0.2]}]}, {link_frame: "gripper_r_base", geometries: [{g_type: 1, g_data: [0, 0, 0.15]}]}]} ]}'
