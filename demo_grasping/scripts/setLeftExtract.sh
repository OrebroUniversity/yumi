...
rosservice call /yumi/hqp_vel_controller/set_tasks '{tasks: [{t_type: 1, priority: 2, name: "ee_l_above_lower_plane", is_equality_task: false, task_frame: "world", ds: 0.0, di: 0.02, dynamics: {d_type: 1, d_data: [-1.0]}, t_links: [{link_frame: "world", geometries: [{g_type: 3, g_data: [0, 0, 1, 0.35]}]}, {link_frame: "gripper_l_base", geometries: [{g_type: 1, g_data: [0, 0, 0]}]}]}, {t_type: 2, priority: 2, name: "gripper_horizontal", is_equality_task: false, task_frame: "world", ds: 0.0, di: 1, dynamics: {d_type: 1, d_data: [-2.5]}, t_links: [{link_frame: "world", geometries: [{g_type: 8, g_data: [0, 0, 0, 0, 0, 1, 0.01]}]}, {link_frame: "gripper_l_base", geometries: [{g_type: 2, g_data: [0, 0, 0, 0, -1, 0]}]}]}, {t_type: 1, priority: 2, name: "ee_l_inside_larger_cylinder", is_equality_task: false, task_frame: "world", ds: 0.0, di: 0.05, dynamics: {d_type: 1, d_data: [-0.5]}, t_links: [{link_frame: "gripper_l_base", geometries: [{g_type: 1, g_data: [0, 0, 0]}]}, {link_frame: "world", geometries: [{g_type: 9, g_data: [0.45, 0.0, 0.115, 0, 0, 1, 0.11]}]}]} ]}'
